...
// clang-format off
struct alignas(simd::kAlignment) RawNetwork {
  ...
  MultiArray<float, arch::kOutputBucketCount, arch::kL3Size * 2, arch::kL2Size> l2_weights;
  MultiArray<float, arch::kOutputBucketCount, arch::kL3Size * 2> l2_biases;
...
struct alignas(simd::kAlignment) Network {
  ...
  alignas(simd::kAlignment) MultiArray<float, arch::kOutputBucketCount, arch::kL2Size, arch::kL3Size * 2> l2_weights;
  alignas(simd::kAlignment) MultiArray<float, arch::kOutputBucketCount, arch::kL3Size * 2> l2_biases;
