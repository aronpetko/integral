...
const Score kMateScore = std::numeric_limits<I16>::max() - 2;
const Score kInfiniteScore = std::numeric_limits<I16>::max() - 1;
const Score kScoreNone = -std::numeric_limits<I16>::max();
