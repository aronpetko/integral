...
TUNABLE(kSeePawnScore, 98, 50, 150, false);
TUNABLE(kSeeKnightScore, 299, 200, 400, false);
TUNABLE(kSeeBishopScore, 300, 200, 400, false);
TUNABLE(kSeeRookScore, 533, 400, 600, false);
TUNABLE(kSeeQueenScore, 921, 700, 1100, false);
