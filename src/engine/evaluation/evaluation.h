...
TUNABLE(kSeeKnightScore, 371, 200, 400, false);
TUNABLE(kSeeBishopScore, 394, 200, 400, false);
TUNABLE(kSeeRookScore, 589, 400, 600, false);
TUNABLE(kSeeQueenScore, 1227, 700, 1500, false);
