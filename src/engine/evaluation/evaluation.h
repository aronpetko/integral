...
TUNABLE(kSeeKnightScore, 298, 200, 400, false);
TUNABLE(kSeeBishopScore, 314, 200, 400, false);
TUNABLE(kSeeRookScore, 531, 400, 600, false);
TUNABLE(kSeeQueenScore, 922, 700, 1100, false);
