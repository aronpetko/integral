...
TUNABLE(kSeePawnScore, 112, 50, 150, false);
TUNABLE(kSeeKnightScore, 372, 200, 400, false);
TUNABLE(kSeeBishopScore, 391, 200, 400, false);
TUNABLE(kSeeRookScore, 592, 400, 600, false);
TUNABLE(kSeeQueenScore, 1214, 700, 1500, false);
