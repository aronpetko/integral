...
TUNABLE(kSeeKnightScore, 293, 200, 400, false);
TUNABLE(kSeeBishopScore, 306, 200, 400, false);
TUNABLE(kSeeRookScore, 545, 400, 600, false);
TUNABLE(kSeeQueenScore, 928, 700, 1100, false);
