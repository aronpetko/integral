...
Score Evaluate(Board &board) {
  ...
  network_eval * (26500 + material_phase) / 32768;

  // Scale down based on proximity to 50 move rule draw
  network_eval = network_eval * (220 - state.fifty_moves_clock) / 220;
