...
Tunable rev_fut_margin("rev_fut_margin", 75, 50, 150, 10);

Tunable null_move_rb("null_move_rb", 3, 1, 5, 0.5);
Tunable null_move_rf("null_move_rf", 4, 2, 8, 1, true);
Tunable null_move_re("null_move_re", 200, 100, 400, 25);

Tunable iir_depth("iir_depth", 4, 2, 8, 1);

Tunable improving_rate_divisor("improving_rate_divisor", 25.0, 5.0, 100.0, 8.0);
...
Tunable fut_margin_base("fut_margin_base", 150, 100, 250, 25);
Tunable fut_margin_mult("fut_margin_mult", 100, 50, 200, 25);

Tunable see_prune_depth("see_prune_depth", 8, 6, 12, 1, true);
Tunable see_quiet_thresh("see_quiet_thresh", -60, -100, -20, 10);
Tunable see_noisy_thresh("see_noisy_thresh", -130, -200, -50, 25);
...
Tunable sing_ext_margin("sing_ext_margin", 2, 1, 4, 0.5);
Tunable sing_double_margin("sing_double_margin", 25, 10, 50, 5);
