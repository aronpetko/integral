...
TUNABLE(kPawnCorrectionWeight, 256, 0, 300, false);
TUNABLE(kNonPawnCorrectionWeight, 256, 0, 300, false);
TUNABLE(kMinorCorrectionWeight, 256, 0, 300, false);
TUNABLE(kMajorCorrectionWeight, 256, 0, 300, false);
TUNABLE(kContinuationCorrectionWeight, 256, 0, 300, false);
