...
TUNABLE(kHistBonusGravity, 10526, 8192, 32768, false);
TUNABLE(kHistBonusScale, 174, 65, 260, false);
TUNABLE(kHistPenaltyScale, 180, 65, 260, false);
TUNABLE(kHistBonusMaxBonus, 1185, 580, 2318, false);
TUNABLE(kHistBonusBias, 102, 0, 300, false);
