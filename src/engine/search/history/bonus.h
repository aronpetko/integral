...
TUNABLE(kHistBonusGravity, 11109, 8192, 32768, false);
TUNABLE(kHistBonusScale, 169, 65, 300, false);
TUNABLE(kHistPenaltyScale, 165, 65, 300, false);
TUNABLE_STEP(kHistBonusMaxBonus, 1235, 580, 2500, false, 200);
