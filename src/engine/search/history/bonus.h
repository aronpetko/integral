...
TUNABLE(kHistBonusGravity, 11011, 8192, 32768, false);
TUNABLE(kHistBonusScale, 182, 65, 300, false);
TUNABLE(kHistPenaltyScale, 169, 65, 300, false);
TUNABLE_STEP(kHistBonusMaxBonus, 1050, 580, 2500, false, 200);
