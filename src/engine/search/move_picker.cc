...
TUNABLE(kBishopScore, 279, 200, 400, false);
...
TUNABLE(kQueenRookThreatScorePos, 19916, 10000, 30000, false);
TUNABLE(kQueenRookThreatScoreNeg, 17497, 10000, 30000, false);
TUNABLE(kRookMinorThreatScorePos, 13540, 5000, 20000, false);
TUNABLE(kRookMinorThreatScoreNeg, 13538, 5000, 20000, false);
TUNABLE(kMinorPawnThreatScorePos, 7927, 3000, 12000, false);
TUNABLE(kMinorPawnThreatScoreNeg, 8491, 3000, 12000, false);

TUNABLE(kDirectCheckBonus, 2092, 512, 6144, false);
