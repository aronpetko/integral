...
TUNABLE(kSeeNoisyHistoryDiv, 99, 32, 250, false);
...
TUNABLE(kQueenScore, 913, 700, 1100, false);
...
TUNABLE(kQueenRookThreatScorePos, 19722, 10000, 30000, false);
TUNABLE(kQueenRookThreatScoreNeg, 18137, 10000, 30000, false);
TUNABLE(kRookMinorThreatScorePos, 13323, 5000, 20000, false);
TUNABLE(kRookMinorThreatScoreNeg, 12737, 5000, 20000, false);
TUNABLE(kMinorPawnThreatScorePos, 8136, 3000, 12000, false);
TUNABLE(kMinorPawnThreatScoreNeg, 8547, 3000, 12000, false);
