...
TUNABLE(kSeeNoisyHistoryDiv, 103, 32, 250, false);
...
TUNABLE(kQueenRookThreatScoreNeg, 19402, 10000, 30000, false);
TUNABLE(kRookMinorThreatScorePos, 12286, 5000, 20000, false);
TUNABLE(kRookMinorThreatScoreNeg, 12568, 5000, 20000, false);
TUNABLE(kMinorPawnThreatScorePos, 7638, 3000, 12000, false);
TUNABLE(kMinorPawnThreatScoreNeg, 7747, 3000, 12000, false);
