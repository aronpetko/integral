...
TUNABLE(kPawnScore, 99, 50, 150, false);
TUNABLE(kKnightScore, 299, 200, 400, false);
TUNABLE(kBishopScore, 299, 200, 400, false);
TUNABLE(kRookScore, 536, 400, 600, false);
TUNABLE(kQueenScore, 916, 700, 1100, false);
...
TUNABLE(kQueenRookThreatScorePos, 19328, 10000, 30000, false);
TUNABLE(kQueenRookThreatScoreNeg, 19622, 10000, 30000, false);
TUNABLE(kRookMinorThreatScorePos, 12027, 5000, 20000, false);
TUNABLE(kRookMinorThreatScoreNeg, 12372, 5000, 20000, false);
TUNABLE(kMinorPawnThreatScorePos, 7747, 3000, 12000, false);
TUNABLE(kMinorPawnThreatScoreNeg, 7780, 3000, 12000, false);
