...
TUNABLE(kSeeNoisyHistoryDiv, 111, 32, 250, false);

TUNABLE(kPawnScore, 97, 50, 150, false);
TUNABLE(kKnightScore, 307, 200, 400, false);
TUNABLE(kBishopScore, 295, 200, 400, false);
TUNABLE(kRookScore, 534, 400, 600, false);
TUNABLE(kQueenScore, 911, 700, 1100, false);
...
TUNABLE(kQueenRookThreatScorePos, 19780, 10000, 30000, false);
TUNABLE(kQueenRookThreatScoreNeg, 19099, 10000, 30000, false);
TUNABLE(kRookMinorThreatScorePos, 12384, 5000, 20000, false);
TUNABLE(kRookMinorThreatScoreNeg, 13276, 5000, 20000, false);
TUNABLE(kMinorPawnThreatScorePos, 8005, 3000, 12000, false);
TUNABLE(kMinorPawnThreatScoreNeg, 8309, 3000, 12000, false);
