...
TUNABLE(kStabilityBase, 1.2786492801531018, 0.5, 2.0, false);
TUNABLE(kStabilitySlope, 0.055450945811961416, 0.02, 0.07, false);
TUNABLE(kScoreChangeBase, 0.115843265713146, 0.05, 0.2, false);
TUNABLE(kSearchScoreCoeff, 0.024248782984287683, 0.01, 0.04, false);
TUNABLE(kPreviousScoreCoeff, 0.02453998156814078, 0.01, 0.04, false);
TUNABLE(kScoreChangeMin, 0.5144326904560652, 0.3, 0.7, false);
TUNABLE(kScoreChangeMax, 1.6575815791158302, 1.25, 2.0, false);
TUNABLE(kNodeFactorBase, 0.5489333107052549, 0.3, 0.7, false);
TUNABLE(kNodeFactorSlope, 2.2845225883915288, 1.8, 2.5, false);
TUNABLE(kNodeFactorIntercept, 0.4562449399787222, 0.2, 0.65, false);
